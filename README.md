...
## Instructions to use in local with Windows OS:

1. Clone repository
   1. git clone https://github.com/issbil/api-trivia-issa-boly.git
2. Install requirements from requirements.txt
   1. cd backend
   2. $ pip install -r requirements.txt
3. Create two databases trivia and trivia_test by using **setup.sql** and **trivia.psql** files
...
6. Execution (**Frontend**)
   ...
   3. npm install
   4. npm start
   5. tape **127.0.0.1:3000** in a browser
...
## Author
1. Issa BOLY (issaboly@gmail.com)
## Remerciements
1. Sarah Maris
2. Sudhanshu Kulshrestha
3. UAnjali
4. Prashanth Reddy
5. Coach Caryn
6. Badiou OURO-BANG'NA
