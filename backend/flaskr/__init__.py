...
def create_app(test_config=None):
    ...
    """
    @app.route('/categories') ##OK
    @cross_origin()
    def retrieve_categories():
        selection = Category.query.order_by(Category.id).all()
        categories = {}
        for categorie in selection:
    ...
    """
    @app.route('/questions',methods=['GET']) ##OK
    @cross_origin()
    ...
    """
    @app.route("/questions/<int:question_id>", methods=["DELETE"]) ##OK
    @cross_origin()
    ...
    @app.route("/questions", methods=["POST"]) ##OK
    @cross_origin()
    def create_question():
                ...
                return jsonify(
                    {
                        ...
                        "current_category": Category.query.get(5).type,
                    }
                )
            else:
    ...
    #NB : TODO below has been done in the above method create_question() 
    """
    @TODO:
    ...
    @app.route('/categories/<int:category_id>/questions') ##OK
    @cross_origin()
